...
class Refund {
  ...
  Map<String, dynamic> toMap() {
    ...
    return {
      ...
      'reason': this.reason.toString().substring(this.reason.toString().indexOf('.')+1),
      'receiptNumber': this.receiptNumber,
      'sourceTransferReversal': this.sourceTransferReversal,
      'status': this.status.toString().substring(this.status.toString().indexOf('.')+1),
      'transferReversal': this.transferReversal,
