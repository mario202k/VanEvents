enum RefundReason {
  ...
  fraudulent,
  requestedByCustomer,
  expiredUncapturedCharge //generated by Stripe internally
}

enum RefundStatus { pending, succeeded, failed, canceled, newDemand, refused }
  ...
  factory Refund.fromMap(Map map) {
    ...
    switch (map['reason'] as String) {
      ...
      case 'expired_uncaptured_charge':
        reason = RefundReason.expiredUncapturedCharge;
        break;
    }
    RefundStatus status;
