...
class UploadEvent extends StatefulWidget {
  ...
  const UploadEvent({this.myEvent});
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                child: Consumer(builder: (context, watch, child) {
                  ...
                  return uploadEventWatch.images.isNotEmpty
                      ? GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            final Asset asset = uploadEventRead.images[index];
                      ...
                      : uploadEventWatch.isUpdating &&
                              widget.myEvent.imagePhotos.isNotEmpty
                          ? GridView.builder(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      FormBuilderTextField(
                        ...
                        onEditingComplete: () {
                          if (uploadEventRead.fbKey.currentState.fields['Titre']
                              .validate()) {
                      ...
                      if (!uploadEventRead.isUpdating)
                        Column(
                          children: <Widget>[
                            ...
                            Consumer(builder: (context, watch, child) {
                              return Visibility(
                                visible: !watch(uploadEventProvider)
                                        .isJusquauJourJ &&
                                ...
                                child: Column(
                                  children: [
                                    FormBuilderDateTimePicker(
                                      ...
                                      controller: uploadEventRead
                                          .debutAfficheController,
                                      onChanged: (dt) {
                                      ...
                                      format:
                                          DateFormat("dd/MM/yyyy 'à' HH:mm"),
                                      decoration: InputDecoration(
                                          labelText: widget.myEvent
                                                      ?.dateDebutAffiche !=
                                                  null
                                              ? DateFormat(
                                                      "dd/MM/yyyy 'à' HH:mm")
                                                  .format(widget.myEvent
                                                      ?.dateDebutAffiche)
                      ...
                      FormBuilderTextField(
                        ...
                        onTap: () async {
                          final place =
                              await Show.showAddress(context, 'UploadEvent');
                      ...
                      FormBuilderTextField(
                        ...
                        style: Theme.of(context).textTheme.bodyText1,
                        decoration:
                            const InputDecoration(labelText: 'Coordonnée'),
              ...
              Row(
                ...
                children: <Widget>[
                  RawMaterialButton(
                    ...
                    elevation: 5.0,
                    fillColor: const Color(0xffFAF4F2),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(
                    '${toggleWatch.eventCostDiscounted == null ? toggleWatch.eventCost.toStringAsFixed(toggleWatch.eventCost.truncateToDouble() == toggleWatch.eventCost ? 0 : 2) : toggleWatch.eventCostDiscounted.toStringAsFixed(toggleWatch.eventCostDiscounted.truncateToDouble() == toggleWatch.eventCostDiscounted ? 0 : 2)} €',
                    style: Theme.of(context).textTheme.bodyText2,
                  ),
                ],
              ),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FormBuilderTextField(
                ...
                focusNode: nodes[0],
                onEditingComplete: () {
                  if (widget.fbKey.currentState.fields['Nom'].validate()) {
                    nodes[0].unfocus();
              ...
              FormBuilderTextField(
                ...
                focusNode: nodes[1],
                onEditingComplete: () {
                  if (widget.fbKey.currentState.fields['Prix'].validate()) {
                    nodes[1].unfocus();
