...
class HomeEvents extends HookWidget  {
  ...
  Widget build(BuildContext context) {
    ...
    final StreamZip<List<MyEvent>> streamZipMaSelection = StreamZip([
      myEventRepo.eventStreamMaSelectionGenre(user?.genres ?? [], user?.lieu ?? [],
          user?.quand ?? [], user?.geoPoint),
      myEventRepo.eventStreamMaSelectionType(user?.types ?? [], user?.lieu ?? [],
          user?.quand ?? [], user?.geoPoint),
    ]);
              ...
              children: <Widget>[
                ...
                IconButton(
                    ...
                    onPressed: () {
                      ...
                      Show.showDialogGenresEtTypes(context, 0, tabController);
